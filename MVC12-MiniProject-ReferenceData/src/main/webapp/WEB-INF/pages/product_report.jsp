			...
			<table border="1" class="table table-striped">
				...
				<c:forEach var="emp" items="${empReport}">
					<tr>
						...
						<td>${emp.price }</td>
						<td>${emp.qty }</td>
						<td><a href="edit?id=${emp.pid}"><img
								src="images/edit.png" width="50" height="50" /></a>&nbsp;&nbsp;
						<td><a onclick="return confirm('really want to delete')"
							href="delete?id=${emp.pid}"><img src="images/delete.png"
